...
goose -dir ./migrations postgres "user=$FEED_SERVICE_POSTGRES_USER password=$FEED_SERVICE_POSTGRES_PASSWORD dbname=$FEED_SERVICE_POSTGRES_DB host=$FEED_SERVICE_POSTGRES_HOST port=$FEED_SERVICE_POSTGRES_PORT sslmode=disable" down