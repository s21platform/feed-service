...
goose -dir ./migrations postgres "user=$FEED_SERVICE__POSTGRES_USER password=$FEED_SERVICE__POSTGRES_PASSWORD dbname=$FEED_SERVICE__POSTGRES_DB host=$FEED_SERVICE__POSTGRES_HOST port=$FEED_SERVICE__POSTGRES_PORT sslmode=disable" up